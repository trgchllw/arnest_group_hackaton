...
function renderCards() {
    ...
    CARDS.forEach(function (c, i) {
        ...
        d.innerHTML = '<h3>' + c.title + '</h3><div class="edu-body">' + c.body + '</div>';
        track.appendChild(d);
